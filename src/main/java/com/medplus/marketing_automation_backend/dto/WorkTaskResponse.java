...
public class WorkTaskResponse {
    ...
    /**
     * True when this task is currently allowed to be started by the assignee.
     * Computed server-side: inFlight < 3 AND (REWORK or top queue position) AND campaign not closed.
     */
    ...
    /** Store ID of the campaign this task belongs to. */
    private String storeId;

    /** Contact number of the campaign this task belongs to. */
    private String contactNumber;

    /** True when the task has at least one unanswered worker comment. */
